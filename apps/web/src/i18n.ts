...
export const fr = {
  ...
  common: {
    unavailable: 'Indisponible', noData: 'Aucune donnée disponible', choose: 'Choisir', optional: 'Optionnel', samples: 'échantillons', confidence: 'confiance', coverage: 'Couverture', engine: 'Moteur', participantRequired: 'Le participant est obligatoire', offlineReady: 'Fonctions essentielles disponibles hors ligne',
  },
  activity: {
  ...
  compare: {
    ...
    modes: { SESSION: 'Session contre session', PARTICIPANT: 'Participant contre participant', EQUIPMENT: 'Équipement contre équipement', GROUP: 'Même sortie commune', SEGMENT: 'Même segment normalisé', EVENT: 'Événements comparables', TEMPORAL: 'Évolution d’un participant', ANALYSIS: 'Versions d’analyse' },
    participantA: 'Participant A', participantB: 'Participant B', equipmentA: 'Équipement A', equipmentB: 'Équipement B', group: 'ActivityGroup', historySession: 'Session avec historique', participant: 'Participant', segmentStart: 'Début', segmentEnd: 'Fin', segmentBody: 'Appliquer la même fenêtre relative aux deux séries sans modifier les RAW.', eventType: 'Type d’événement', sessionA: 'Session A', sessionB: 'Session B', temporalEvolution: 'Évolution temporelle',
  },
  settings: {
    title: 'Réglages', appearance: 'Apparence', light: 'Clair', dark: 'Sombre', system: 'Système', maps: 'Cartographie', freeSource: 'Source libre', standardMap: 'OpenStreetMap standard', topoMap: 'OpenTopoMap relief', mapNotice: 'La carte dépend du réseau en V1. L’enregistrement, les analyses et la trace restent utilisables sans fond cartographique.', data: 'Données', backup: 'Sauvegarde complète', backupBody: 'Participants, équipements, appareils, groupes, sessions, profils, analyses, réglages et RAW', restore: 'Restaurer .tabackup', restoreBody: 'Vérifier le format et les empreintes avant restauration', privacy: 'Local par défaut', privacyBody: 'Aucune télémétrie, aucun compte et aucun envoi automatique. Tout export est déclenché explicitement.',
  },
} as const
