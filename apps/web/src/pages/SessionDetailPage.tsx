...
import { ArrowLeft, Database, Download, GitCompareArrows, RefreshCw } from 'lucide-react'
...
export function SessionDetailPage(): ReactNode {
  const { id } = useParams()
  const { sessions, participants, equipment, analysisRuns, analysisProfiles, settings, reanalyzeSession } = useAppData()
